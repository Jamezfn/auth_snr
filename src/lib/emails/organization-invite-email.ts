...
export async function sendOrganizationInviteEmail({
	...
	await sendEmail({
		...
		<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
			...
			<a href="${process.env.BETTER_AUTH_URL}/organisations/invites/${invitation.id}" style="background-color: #28a745; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; margin: 16px 0;">Manage Invitation</a>
